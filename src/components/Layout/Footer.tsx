...
function Footer() {
  return (
    <footer className={`globalPadding ${styles.footerContainer}`}>
      <svg
      ...
      <div className={styles.linksWarningContainer}>
        <div className={styles.linksEmailContainer}>
          ...
          <p className={styles.email}>nwick@gmail.com</p>
        </div>
        <p className={styles.warning}>
          <Link className={styles.link} to="/">
            Nwick.com
          </Link>{" "}
          © 2025 SELECT | All rights reserved. The use of this website means
          that you accept the confidentiality regulations and the conditions of
          service.
        </p>
      </div>
    </footer>
